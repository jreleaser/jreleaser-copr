...
install -p -m 644 lib/commonmark-0.20.0.jar %{_appdir}/lib/commonmark-0.20.0.jar
...
install -p -m 644 lib/feign-jackson-11.10.jar %{_appdir}/lib/feign-jackson-11.10.jar
...
install -p -m 644 lib/jackson-annotations-2.13.4.jar %{_appdir}/lib/jackson-annotations-2.13.4.jar
install -p -m 644 lib/jackson-core-2.13.4.jar %{_appdir}/lib/jackson-core-2.13.4.jar
install -p -m 644 lib/jackson-databind-2.13.4.jar %{_appdir}/lib/jackson-databind-2.13.4.jar
install -p -m 644 lib/jackson-dataformat-cbor-2.13.4.jar %{_appdir}/lib/jackson-dataformat-cbor-2.13.4.jar
install -p -m 644 lib/jackson-dataformat-toml-2.13.4.jar %{_appdir}/lib/jackson-dataformat-toml-2.13.4.jar
install -p -m 644 lib/jackson-dataformat-xml-2.13.4.jar %{_appdir}/lib/jackson-dataformat-xml-2.13.4.jar
install -p -m 644 lib/jackson-dataformat-yaml-2.13.4.jar %{_appdir}/lib/jackson-dataformat-yaml-2.13.4.jar
...
install -p -m 644 lib/slf4j-api-2.0.3.jar %{_appdir}/lib/slf4j-api-2.0.3.jar
install -p -m 644 lib/slf4j-simple-2.0.3.jar %{_appdir}/lib/slf4j-simple-2.0.3.jar
...
install -p -m 644 lib/tika-core-2.5.0.jar %{_appdir}/lib/tika-core-2.5.0.jar
install -p -m 644 lib/twitter4j-core-4.0.7.jar %{_appdir}/lib/twitter4j-core-4.0.7.jar
install -p -m 644 lib/woodstox-core-6.3.1.jar %{_appdir}/lib/woodstox-core-6.3.1.jar
...
%{_datadir}/%{name}/lib/commonmark-0.20.0.jar
...
%{_datadir}/%{name}/lib/feign-jackson-11.10.jar
...
%{_datadir}/%{name}/lib/jackson-annotations-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-core-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-databind-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-dataformat-cbor-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-dataformat-toml-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-dataformat-xml-2.13.4.jar
%{_datadir}/%{name}/lib/jackson-dataformat-yaml-2.13.4.jar
...
%{_datadir}/%{name}/lib/slf4j-api-2.0.3.jar
%{_datadir}/%{name}/lib/slf4j-simple-2.0.3.jar
%{_datadir}/%{name}/lib/snakeyaml-1.30.jar
%{_datadir}/%{name}/lib/sshj-0.34.0.jar
%{_datadir}/%{name}/lib/stax2-api-4.2.1.jar
%{_datadir}/%{name}/lib/tika-core-2.5.0.jar
%{_datadir}/%{name}/lib/twitter4j-core-4.0.7.jar
%{_datadir}/%{name}/lib/woodstox-core-6.3.1.jar
