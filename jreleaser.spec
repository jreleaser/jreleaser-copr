...
install -p -m 644 lib/artifactory-java-sdk-1.0.0-M1.jar %{_appdir}/lib/artifactory-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/codeberg-java-sdk-1.0.0-M1.jar %{_appdir}/lib/codeberg-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/discord-java-sdk-1.0.0-M1.jar %{_appdir}/lib/discord-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/genericgit-java-sdk-1.0.0-M1.jar %{_appdir}/lib/genericgit-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/git-sdk-1.0.0-M1.jar %{_appdir}/lib/git-sdk-1.0.0-M1.jar
install -p -m 644 lib/gitea-java-sdk-1.0.0-M1.jar %{_appdir}/lib/gitea-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/github-api-1.129.jar %{_appdir}/lib/github-api-1.129.jar
install -p -m 644 lib/github-java-sdk-1.0.0-M1.jar %{_appdir}/lib/github-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/gitlab-java-sdk-1.0.0-M1.jar %{_appdir}/lib/gitlab-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/gitter-java-sdk-1.0.0-M1.jar %{_appdir}/lib/gitter-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/google-chat-java-sdk-1.0.0-M1.jar %{_appdir}/lib/google-chat-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/http-upload-java-sdk-1.0.0-M1.jar %{_appdir}/lib/http-upload-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/java-sdk-commons-1.0.0-M1.jar %{_appdir}/lib/java-sdk-commons-1.0.0-M1.jar
...
install -p -m 644 lib/jreleaser-1.0.0-M1.jar %{_appdir}/lib/jreleaser-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-assemblers-1.0.0-M1.jar %{_appdir}/lib/jreleaser-assemblers-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-config-json-1.0.0-M1.jar %{_appdir}/lib/jreleaser-config-json-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-config-toml-1.0.0-M1.jar %{_appdir}/lib/jreleaser-config-toml-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-config-yaml-1.0.0-M1.jar %{_appdir}/lib/jreleaser-config-yaml-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-engine-1.0.0-M1.jar %{_appdir}/lib/jreleaser-engine-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-model-1.0.0-M1.jar %{_appdir}/lib/jreleaser-model-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-templates-1.0.0-M1.jar %{_appdir}/lib/jreleaser-templates-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-tools-1.0.0-M1.jar %{_appdir}/lib/jreleaser-tools-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-utils-1.0.0-M1.jar %{_appdir}/lib/jreleaser-utils-1.0.0-M1.jar
install -p -m 644 lib/jreleaser-workflow-1.0.0-M1.jar %{_appdir}/lib/jreleaser-workflow-1.0.0-M1.jar
...
install -p -m 644 lib/mail-java-sdk-1.0.0-M1.jar %{_appdir}/lib/mail-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/mastodon-java-sdk-1.0.0-M1.jar %{_appdir}/lib/mastodon-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/mattermost-java-sdk-1.0.0-M1.jar %{_appdir}/lib/mattermost-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/s3-java-sdk-1.0.0-M1.jar %{_appdir}/lib/s3-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/sdkman-java-sdk-1.0.0-M1.jar %{_appdir}/lib/sdkman-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/slack-java-sdk-1.0.0-M1.jar %{_appdir}/lib/slack-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/teams-java-sdk-1.0.0-M1.jar %{_appdir}/lib/teams-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/telegram-java-sdk-1.0.0-M1.jar %{_appdir}/lib/telegram-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/tika-core-2.2.1.jar %{_appdir}/lib/tika-core-2.2.1.jar
install -p -m 644 lib/tool-sdk-1.0.0-M1.jar %{_appdir}/lib/tool-sdk-1.0.0-M1.jar
install -p -m 644 lib/twitter-java-sdk-1.0.0-M1.jar %{_appdir}/lib/twitter-java-sdk-1.0.0-M1.jar
install -p -m 644 lib/twitter4j-core-4.0.7.jar %{_appdir}/lib/twitter4j-core-4.0.7.jar
install -p -m 644 lib/webhooks-java-sdk-1.0.0-M1.jar %{_appdir}/lib/webhooks-java-sdk-1.0.0-M1.jar
...
install -p -m 644 lib/zulip-java-sdk-1.0.0-M1.jar %{_appdir}/lib/zulip-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/artifactory-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/codeberg-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/discord-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/genericgit-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/git-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/gitea-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/github-api-1.129.jar
%{_datadir}/%{name}/lib/github-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/gitlab-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/gitter-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/google-chat-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/http-upload-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/java-sdk-commons-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/jreleaser-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-assemblers-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-config-json-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-config-toml-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-config-yaml-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-engine-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-model-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-templates-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-tools-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-utils-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jreleaser-workflow-1.0.0-M1.jar
%{_datadir}/%{name}/lib/jsonschema-generator-4.22.0.jar
%{_datadir}/%{name}/lib/jsonschema-module-jackson-4.22.0.jar
%{_datadir}/%{name}/lib/mail-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/mastodon-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/mattermost-java-sdk-1.0.0-M1.jar
...
%{_datadir}/%{name}/lib/s3-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/sdkman-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/slack-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/slf4j-api-1.7.33.jar
%{_datadir}/%{name}/lib/slf4j-simple-1.7.33.jar
%{_datadir}/%{name}/lib/snakeyaml-1.30.jar
%{_datadir}/%{name}/lib/teams-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/telegram-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/tika-core-2.2.1.jar
%{_datadir}/%{name}/lib/tool-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/twitter-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/twitter4j-core-4.0.7.jar
%{_datadir}/%{name}/lib/webhooks-java-sdk-1.0.0-M1.jar
%{_datadir}/%{name}/lib/yamllint-1.5.0.jar
%{_datadir}/%{name}/lib/zt-exec-1.12.jar
%{_datadir}/%{name}/lib/zulip-java-sdk-1.0.0-M1.jar
